#!/usr/bin/env python3
"""
SAPM Monte Carlo Simulation — Insurance & Climate Risk / Tail Risk Exclusion Ratchet
======================================================

Reproduces all quantitative results in:

  Postnieks, E. (2026). SAPM Working Paper: Insurance & Climate Risk (Tail Risk Exclusion Ratchet).
  Available: SSRN.
...
CONFIG = {
    "paper_id": "insurance_climate",
    "domain_name": "Insurance & Climate Risk",
    "theorem": "Tail Risk Exclusion Ratchet",
    "classification": "Class 2 \u2014 Intractability",
    "seed": 42,
    "n_draws": 100000,
    "correlation_rho": 0.3,
    "private_payoff_B": 90.0,
    "channels": {
        "C1_insured_catastrophe_losses": {
            ...
            "high": 267.3,
            "weight": 0.35,
            "description": "Insured natural catastrophe losses from climate-intensified perils. $137B insured losses 2024 (Swiss Re sigma), $148B projected 2026. Subsidized premiums induce construction in high-risk zones. Sources: Swiss Re sigma, Munich Re NatCatSERVICE."
        },
        "C2_protection_gap": {
            "dist": "lognormal",
            "low": 55.7,
            ...
            "high": 167.0,
            "weight": 0.25,
            "description": "Uninsured losses from coverage withdrawal. $181B global protection gap 2024. Private insurers non-renew as actuarial losses accumulate; State Farm, Allstate exit CA. Sources: Swiss Re, Geneva Association, First Street Foundation."
        },
        "C3_nfip_residual_market": {
            ...
            "high": 97.2,
            "weight": 0.2,
            "description": "NFIP moral hazard + residual market distortion. NFIP $20.5B Treasury debt, FAIR Plan exposure $50B\u2192$650B in 7yrs, FL Citizens 1.42M policies peak. Premiums set below actuarial cost for political palatability. Sources: FEMA, NAIC, CA FAIR Plan."
        },
        "C4_property_stranding": {
            ...
            "high": 66.8,
            "weight": 0.1,
            "description": "Property value destruction and climate migration. $1.47T stranding pipeline over 30yrs (First Street). 84% of US census tracts face downward property value pressure. Annualized ~$50B understates correlated correction tail risk. Sources: First Street Foundation, Zillow."
        },
        "C5_governance_regulatory_failure": {
            ...
            "high": 33.3,
            "weight": 0.1,
            "description": "Regulatory capture, revolving door, rate suppression. \u03ba=0.08 capture coefficient. Insurance lobbying generates orders-of-magnitude-larger welfare costs. 12 LA insurers insolvent 2021-2023. Sources: NAIC, state insurance dept filings, OpenSecrets."
        }
    },
